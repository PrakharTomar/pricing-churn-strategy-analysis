...
- How pricing and contracts can be used to improve retention
...
- Service bundle effects on churn
- Payment method and operational churn
- Internet type (DSL vs Fiber) analysis
...
- Auto pay reduces churn significantly
- Retention of high paying customers is more valuable than price increases
...
- Apply selective price increases to stable DSL customers
